    ...
    <div className='ticket'>
      <div className='p-6'>
        ...
        <div className='flex items-center justify-between mt-6'>
          ...
          <div className='grow bg-gray-100 relative'>
            <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[256px] border border-dashed border-[#C2C5CF]'>
