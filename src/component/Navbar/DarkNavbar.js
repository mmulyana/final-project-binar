  ...
  return (
    <>
      <nav className='fixed top-0 left-0 z-50 w-full pt-4 bg-white'>
        <div className='container max-w-[1200px] px-4 lg:px-0 mx-auto flex items-center justify-between relative z-10 pb-4'>
          <MediaQuery minWidth={786}>
            <div className='flex items-center gap-14'>
              ...
              <nav className='flex items-center gap-10'>
                <Link
                  href='/'
                  className='text-sm text-slate-700 flex gap-2 items-center px-4 py-2 hover:bg-gray-50 rounded'
                >
                  Promo
                  <svg
                    width='16'
                ...
                <Link
                  href='/'
                  className='text-sm text-slate-700 px-4 py-2 hover:bg-gray-50 rounded'
                >
                  Cek Pesanan
                </Link>
                <Link
            ...
            <Button
              ...
              className='px-6 py-4 text-white font-medium bg-[#326BF1] rounded shadow-sm text-sm'
            >
              Masuk/Daftar
            </Button>
          </MediaQuery>
